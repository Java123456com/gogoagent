"""L2 向量识别种子语料（对应 intent-seed.yml，1:1 提取）。

刻意剔除能被 L1 关键词命中的说法，只保留自然口语、整句、带场景、不含 L1 触发词的
表达，作为 L1 的语义兜底补充。
"""
...
SEED_EXAMPLES: dict[IntentCategory, list[str]] = {
    IntentCategory.TRAVEL_APPLICATION: [
        "下周得去客户现场驻场几天，帮我在系统里走一下流程",
        "月底要去参加行业展会，帮我登记一下这趟公务",
        "老板让我去趟广州对接项目，得先在OA里发起个手续",
        "我打算去总部待三天，帮我提交给领导审一下这趟",
        "这次去见客户是公司派的，帮我把出行手续办了",
        "月底要去杭州开个会，帮我安排一下这趟出差",
    ],
    ...
    IntentCategory.ITINERARY_PLANNING: [
        "这次去成都三天，帮我把每天的日程都排明白",
        "去广州见两个客户，帮我把这两天的事情统筹一下",
        "帮我把往返交通和住的地方整体捋成一个计划",
        "这趟怎么排比较顺，帮我通盘想一个方案",
    ],
    ...
    IntentCategory.UNKNOWN: [
        "随便问问", "这个怎么说", "你能做什么", "你有哪些功能", "帮助", "你是谁", "我该怎么用你",
    ],
}
